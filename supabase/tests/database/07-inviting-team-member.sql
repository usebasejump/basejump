...
-- create invitation
SELECT row_eq(
               $$ insert into basejump.invitations (account_id, account_role, token, invitation_type) values ('d126ecef-35f6-4b5d-9f28-d9f00a9fb46f', 'member', 'test_member_single_use_token', 'one-time') returning 1 $$,
               ROW (1),
