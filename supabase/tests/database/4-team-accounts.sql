...
SELECT row_eq(
               ...
               ROW (tests.get_supabase_uid('test1'), 'owner'::account_role),
...
SELECT throws_ok(
               $$ update accounts set primary_owner_user_id = tests.get_supabase_uid('test2') where personal_account = false $$,
...
SELECT throws_ok(
               $$ insert into account_user (account_id, account_role, user_id) values ('8fcec130-27cd-4374-9e47-3303f9529479', 'owner', tests.get_supabase_uid('test2')) $$,
...
insert into account_user (account_id, account_role, user_id)
...
SELECT row_eq(
               $$ select account_role from account_user where account_id = '8fcec130-27cd-4374-9e47-3303f9529479' and user_id = tests.get_supabase_uid('test_member')$$,
...
-- account_user should have a role of member
SELECT row_eq(
               $$ select account_role from account_user where account_id = '8fcec130-27cd-4374-9e47-3303f9529479' and user_id = tests.get_supabase_uid('test_owner')$$,
