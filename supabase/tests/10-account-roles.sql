BEGIN;
    ...
    INSERT INTO auth.users (email, id) VALUES ('primary@test.com', '1009e39a-fa61-4aab-a762-e7b1f3b014f3');
    INSERT INTO auth.users (email, id) VALUES('owner@test.com', '5d94cce7-054f-4d01-a9ec-51e7b7ba8d59');
    INSERT INTO auth.users (email, id) VALUES('member@test.com', '29669d3a-a502-491f-b4f0-0211910ed7eb');
    ...
    insert into account_user (account_id, user_id, account_role) values ('d126ecef-35f6-4b5d-9f28-d9f00a9fb46f', '5d94cce7-054f-4d01-a9ec-51e7b7ba8d59', 'owner');
    insert into account_user (account_id, user_id, account_role) values ('d126ecef-35f6-4b5d-9f28-d9f00a9fb46f', '29669d3a-a502-491f-b4f0-0211910ed7eb', 'member');
